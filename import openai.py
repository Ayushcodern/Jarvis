        ...
        if listen_for_wake_word():
            ...
            while True:
                ...
                if 'wikipedia' in query:
                    ...
                    speak("Yes sir, it's all your power to build me up.")
                    ...
                    speak("Yes sir, I am online in just a few seconds.")
                    for _ in range(7):
                        speak("")
                    ...
                    speak("If anyone asks me what is your language, I say my language is English, but written language is Python.")

                elif 'connect watch' in query:
                    speak("Connecting server of MI watch.")

                elif 'say hi to my friend' in query:
                    speak("Hi sir, you are a friend of Ayush.")

                elif 'are you human' in query:
                    speak("No, I am not a human, but I am AI.")
